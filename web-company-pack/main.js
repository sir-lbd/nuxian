...
var map = {
	...
	"../launch-evaluation/launch-evaluation.module": [
	...
	"../quality-file/quality-file.module": [
...
var HttpJSON = /** @class */ (function () {
    ...
    HttpJSON.prototype.$extend = function (json, isMergeToSelf) {
        ...
        this.$keys(json).forEach(function (key) { return replica[key] = json[key]; });
        return replica;
    };
    HttpJSON.prototype.$copy = function () {
        var _this = this;
        var replica = new HttpJSON();
        this.$keys().forEach(function (key) { return replica.$set(key, _this[key].join(';')); });
        return replica;
    };
    return HttpJSON;
}());
...
module.exports = __webpack_require__(/*! /Users/qloong/Desktop/projects/muxian/web-company/src/index.ts */"./src/index.ts");
