...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(_ctrl, _router, service, location) {
        ...
        this.pages = ['/mine/user-info', '/mine/evaluation-records', '/user-care/evaluation'];
    ...
    HeaderComponent.prototype.alert = function () {
        ...
        if (activeUrl !== '/user-care/evaluation') {
            this.showAlert = true;
        }
    };
...
var MainComponent = /** @class */ (function () {
    function MainComponent(_ctrl, http, router) {
        this._ctrl = _ctrl;
        this.http = http;
        this.router = router;
    }
    ...
    MainComponent = __decorate([
        ...
        __metadata("design:paramtypes", [controller_service_1.PageController, http_1.Http, router_1.Router])
    ], MainComponent);
