...
@Component({
  selector: 'app-project-texsted',
  templateUrl: './project-texsted.component.html',
  styleUrls: ['./project-texsted.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ProjectTexstedComponent implements OnInit {
  isShow = false;
  id: number;
  color = 0;
  left = [
